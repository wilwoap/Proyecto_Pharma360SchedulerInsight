...
El script siempre fija Platform=x64, valida que no aumenten las advertencias heredadas, ejecuta al menos 37 pruebas de caracterización y muestra el SHA-256 del ejecutable producido.
